...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/72Beci6SQH)
...
```sh
npx nx serve stream-vibe
```

To create a production bundle:

```sh
npx nx build stream-vibe
```

To see all available targets to run for a project, run:

```sh
npx nx show project stream-vibe
```
